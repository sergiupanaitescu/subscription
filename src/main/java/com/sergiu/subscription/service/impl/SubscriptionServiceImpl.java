...
public class SubscriptionServiceImpl implements SubscriptionService{
	...
	public SubscriptionServiceImpl(PlanRepository planRepo, ProductRepository productRepo,
	...
	public ReturnSubscriptionDTO updateSubscription(RequestSubscriptionDTO updatedSubscription) {
		Optional<Subscription> subscriptionOptional = subscriptionRepo.findById(updatedSubscription.getUserId());
		if (subscriptionOptional.isPresent()) {
			Subscription sub = subscriptionOptional.get();
			return saveOrUpdateSubscription(updatedSubscription, sub);
		} else {
	        logger.error(String.format("Subscription with id: %s not found!", updatedSubscription.getUserId()));
